...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d5 = new Department(5, "properties");

            Seller s1 = new Seller(1, "João V.", "JoaoV@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1); ;
            Seller s2 = new Seller(2, "Sarah Silva", "saraHS@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Larissa M.", "MLarissa@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Sthefany G.", "StheG@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Lucas W.", "lucaswoibau7@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Bernardo D. G.", "BEdg@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
